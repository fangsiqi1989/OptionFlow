...
# python C:\Users\Siqi\Desktop\OptionFlow\broadcast_remote_telegram.py -url https://app.flowalgo.com/ -login_url https://app.flowalgo.com/users/login -proxy http:52.179.18.244:8080 -username optionflow2 -password option123 -free_target "Option Flow Free" -vip_target "Option Flow"
