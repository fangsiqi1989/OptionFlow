...
# python C:\Users\Administrator\Desktop\Flowalgo\broadcast.py -url https://app.flowalgo.com/ -login_url https://app.flowalgo.com/users/login -proxy http:45.55.236.139:2244 -username myoption1 -password Cyc312503 -target Option Flow
# python C:\Users\Siqi\Desktop\Flowalgo\broadcast.py -url https://app.flowalgo.com/ -login_url https://app.flowalgo.com/users/login -proxy http:209.141.49.11:8080 -username optionflow -password ethan123456 -target "Option Flow"
# python C:\Users\Siqi\Desktop\OptionFlow\broadcast_local_test.py -url https://app.flowalgo.com/ -login_url https://app.flowalgo.com/users/login -proxy http:209.141.49.11:8080 -username myoption5 -password option123 -free_target "琪琪鲁" -vip_target "琪琪鲁"
...
class Extract:
    ...
    def extract(self, session):
        ...
        f = open("flowalgo.html", "w")
        with open('myfile.txt', 'w') as fp:
            pass
        # with open('flowalgo.html', 'w') as fp:
        #     fp.write(response.content.decode('utf-8'))
        text_file = open("flowalgo.html", "w")
        ...
        for d in data:
            ...
            sql = """
                ...
                """
            print(time, timestamp, ticker, expiry, ContractType, strike, SpotPrice, ContractSizePrice, MultiExchangeSweep,
